    ...
    public partial class frw_componentes : System.Web.UI.Page
    {
        ...
        private void llenarGridView()
        {
            try
            {
                ...
                if (this.grd_listaComponente.Rows.Count == 0)
                {
                    this.mostrarNoDatos();
                }
            }
        ...
        public void mostrarNoDatos()
        {
            ...
            vo_lista.Add(new cls_componente());
            this.grd_listaComponente.DataSource = vo_lista;
            this.grd_listaComponente.DataBind();

            for (int i = 0; i < this.grd_listaComponente.Columns.Count; i++)
            {
                this.grd_listaComponente.Rows[0].Cells[i].Text = String.Empty;
            }

            this.grd_listaComponente.Rows[0].Cells[1].ColumnSpan = this.grd_listaComponente.Columns.Count;
            this.grd_listaComponente.Rows[0].Cells[1].Text = "No se encontraron datos.";
        ...
        private int guardarDatos()
        {
            ...
            vo_componente.pUsuarioTransaccion = ((cls_usuario)Session["cls_usuario"]).pPK_usuario;
        ...
        protected void btn_cancelar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.ucSearchComponente_searchClick(null, null, null, null);
            }
            catch (Exception po_exception)
            {
