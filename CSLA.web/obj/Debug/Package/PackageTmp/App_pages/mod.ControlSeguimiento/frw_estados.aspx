<%@ Page Title="" Language="C#" MasterPageFile="~/msp.EstiloBasico/mspContenido.Master"
    AutoEventWireup="true" CodeBehind="frw_estados.aspx.cs" Inherits="CSLA.web.App_pages.mod.ControlSeguimiento.frw_estados" %>
            ...
            <act:Accordion ID="ard_principal" runat="server" SelectedIndex="0" FadeTransitions="false"
                ...
                <Panes>
                    <act:AccordionPane ID="acp_listadoDatos" runat="server">
                        <Header>
                            <a href="" style="color: #FFFFFF; font-size: 12px;">Listado de Estados</a>
                        </Header>
                        <Content>
                            <table id="tbl_contenido">
                                ...
                                <tr>
                                    <td>
                                        <%-- Búsqueda--%>
                                        <cc1:ucSearch ID="ucSearchEstado" runat="server" OnSearchClick="ucSearchEstado_searchClick" />
                                ...
                                <tr>
                                    <td>
                                        <%-- GridView--%>
                                        <asp:GridView ID="grd_listaEstado" AllowPaging="True" runat="server" AutoGenerateColumns="False"
                                            Width="100%" CssClass="Grid" CellSpacing="1" CellPadding="3" OnRowCommand="grd_listaEstado_RowCommand"
                                            OnPageIndexChanging="grd_listaEstado_PageIndexChanging">
                                            <PagerSettings PageButtonCount="20" />
                                            <Columns>
                                                <asp:BoundField DataField="pPK_estado" HeaderText="Estado" SortExpression="pPK_estado" />
                    ...
                    <act:AccordionPane ID="acp_edicionDatos" runat="server">
                        <Header>
                            <a href="" style="color: #FFFFFF; font-size: 12px;">Edici&oacute;n de Estados</a>
                        </Header>
                        <Content>
                            <table id="Table1">
                                <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <td>
                                                        <asp:RequiredFieldValidator ID="rfv_descripcion" runat="server" ControlToValidate="txt_descripcion"
                                                            ToolTip="Ingrese la descripcion del estado" ErrorMessage="Descripcion es requerida"><img alt="imagen" width="25px" height="20px" src="../../App_Themes/Basico/botones/img_warning.gif" border="none"/></asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="rfv_descripcionlenght" runat="server" ErrorMessage="La longitud máxima son 30 caracteres." 
                                                            ValidationExpression="^([\S\s]{0,30})$" ControlToValidate="txt_descripcion" Display="Dynamic"></asp:RegularExpressionValidator>
                                                    </td>
                                            </tr>
                                        </table>
                                    </td>
