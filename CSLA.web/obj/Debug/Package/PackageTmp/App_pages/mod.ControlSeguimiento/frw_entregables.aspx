<%@ Page Title="" Language="C#" MasterPageFile="~/msp.EstiloBasico/mspContenido.Master"
    AutoEventWireup="true" CodeBehind="frw_entregables.aspx.cs" Inherits="CSLA.web.App_pages.mod.ControlSeguimiento.frw_entregables" %>
            ...
            <act:Accordion ID="ard_principal" runat="server" SelectedIndex="0" FadeTransitions="false"
                ...
                <Panes>
                    <act:AccordionPane ID="acp_listadoDatos" runat="server">
                        <Header>
                            <a href="" style="color: #FFFFFF; font-size: 12px;">Listado de Entregables</a>
                        </Header>
                        <Content>
                            <table id="tbl_contenido">
                                ...
                                <tr>
                                    <td>
                                        <%-- Búsqueda--%>
                                        <cc1:ucSearch ID="ucSearchEntregable" runat="server" OnSearchClick="ucSearchEntregable_searchClick" />
                                ...
                                <tr>
                                    <td>
                                        <%-- GridView--%>
                                        <asp:GridView ID="grd_listaEntregable" AllowPaging="True" runat="server" AutoGenerateColumns="False"
                                            Width="100%" CssClass="Grid" CellSpacing="1" CellPadding="3" OnRowCommand="grd_listaEntregable_RowCommand"
                                            OnPageIndexChanging="grd_listaEntregable_PageIndexChanging">
                                            <PagerSettings PageButtonCount="20" />
                                            <Columns>
                                                <asp:BoundField DataField="pPK_entregable" HeaderText="Entregable" SortExpression="pPK_entregable" />
                    ...
                    <act:AccordionPane ID="acp_edicionDatos" runat="server">
                        <Header>
                            <a href="" style="color: #FFFFFF; font-size: 12px;">Edici&oacute;n de Entregables</a>
                        </Header>
                        <Content>
                            <table id="Table1">
                                <tr>
